...
> Contains the most useful and repeated commands.
...
# 2-DML (Data Data Manipulation Language) :
>  [!NOTE]  
> ## $\color{blue}{are\ the\ element\ in\ the\ SQL\ language\ that\ is\ used\ for\ data\ retrieval\ and\ manipulation.\ }$
>  ## $\color{blue}{Using\ these\ statements\ you\ can\ perform\ operations\ such\ as:\ adding\ new\ rows,\ updating\ and\ deleting\ existing\ rows,\ merging\ tables\ and\ so\ on.\ }$
